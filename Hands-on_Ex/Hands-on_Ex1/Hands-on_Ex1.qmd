...
ggplot(data=mpsz3414, 
  ...
  geom_point() + xlim(0,40) + ylim(0,40) + 
...
In this hands-on exercise, I learn how to plot functional and truthful choropleth maps with R.
...
### Plotting a choropleth map by using *qtm()*
